...
const AssignDefaultService = ({}: any) => {
  const {
    register,
    handleSubmit,
    control,
  ...
  const onSubmit = async (data: any) => {
    ...
    const arg: MerchantPaymentServicePayload = { ...data }
    if (isCustomRate) {
  ...
  return (
    <>
      <SectionHeader
        title="Assign Default Service"
        subtitle="Assign a default service to the merchant and configure its integration details."
      />
...
export default AssignDefaultService
